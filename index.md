...
Use
[`d2_which()`](https://elipousson.github.io/d2r/reference/d2-utils.md)
...
to create a basic diagram with two connected shapes based on a named
character vector:
...
![](reference/figures/README-simple_diagram.png)
...
![](reference/figures/README-connected_diagram.png)

The entity-relationship diagrams and table schema can be represented
using the SQL table style diagrams with
...
![](reference/figures/README-mtcars.png)

You can use
[`d2_render()`](https://elipousson.github.io/d2r/reference/d2_render.md)
to convert a D2 file into a PNG, SVG, PDF, TXT, or GIF file.

[`d2_include()`](https://elipousson.github.io/d2r/reference/d2_render.md)
is a wrapper for
...
![](reference/figures/README-include-example.png)
